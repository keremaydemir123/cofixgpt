...
function HomePage() {
  return (
    <div className="flex flex-col items-center justify-center h-full">
      <div className="md:max-w-[800px] w-full flex flex-col flex-1 items-center justify-center gap-8">
        <div className="text-center">
          ...
          <p className="prone w-full md:text-lg text-md text-center mt-4">
            ...
            <span className="underline decoration-secondary">refactor</span>,
            and <span className="underline decoration-accent">comment</span>{" "}
            your code in minutes. Enhance your productivity and code quality
            with our streamlined solution. Try it now!
          </p>
        </div>
      ...
      <div className="flex items-center gap-2 h-20 text-3xl">
        <ColorfulHeader
